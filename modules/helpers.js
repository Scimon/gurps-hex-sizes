...
export function getAltSnappingFlag(token){
    let altSnapping = token.document.getFlag("gurps-hex-sizes", "altSnapping");
...
export function getEvenSnappingFlag(token){
    let evenSnapping = token.document.getFlag("gurps-hex-sizes", "evenSnap");
...
export function getAltOrientationFlag(token){
    let altOrientation = token.document.getFlag("gurps-hex-sizes","alternateOrientation");
